...
export const UserTieIcon: React.FC<{className?: string}> = (props) => (
  <svg {...props} stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 512 512" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
    <path d="M256 256c52.805 0 96-43.201 96-96s-43.195-96-96-96-96 43.201-96 96 43.195 96 96 96zm0 48c-61.75 0-112 50.25-112 112v8H144c0-35.346 28.654-64 64-64h96c35.346 0 64 28.654 64 64v8c0-61.75-50.25-112-112-112z"></path>
    <path d="M256 336c-17.673 0-32 14.327-32 32v128h64V368c0-17.673-14.327-32-32-32z"></path>
  </svg>
);

export const FolderOpenIcon: React.FC<{className?: string}> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const WarehouseIcon: React.FC<{className?: string}> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M22 8V6a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2v2"></path>
        <path d="M22 8v12a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V8"></path>
        <path d="M12 22V8"></path><path d="M12 8l8-4"></path>
        <path d="M12 8L4 4"></path><path d="M18 15h-3v-2h3v2z"></path>
    </svg>
);
...
export const RocketIcon: React.FC<{className?: string}> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <path d="m12 15-3-3a9 9 0 0 1 3-13l3 3a9 9 0 0 1-13 3z"></path>
        <path d="M16 16c-3 3-6 6-6 6"></path><path d="M20 12c0-3-3-6-6-6"></path>
    </svg>
);
...
// Ikon ini ditambahkan untuk konsistensi di Experience.tsx
